...
import obtenerModelosCompletos from '../config/obtenerModelosCompletos';

const useModelosCompletos = (idFamilia) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const response = await obtenerModelosCompletos(idFamilia);
...
export default useModelosCompletos;